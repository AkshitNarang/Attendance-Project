...
Label(frame1, text='Course Name      :').grid(row=1, column=0, padx=10, pady=10)
Label(frame1, text="Teacher's Name  :").grid(row=2, column=0, padx=10, pady=10)
...
Checkbutton(frame1, text='The above information mentioned is correct', variable=cb,
            onvalue=1, offvalue=0, command=termsCheck).grid(row=150, columnspan=4, pady=10)
submit_btn = Button(frame1, text="Ready to Scan QR", bg='light green',
                    command=ws.destroy, padx=50, pady=10, state=DISABLED)
submit_btn.grid(row=250, columnspan=4, pady=2)

ws.mainloop()


###################################################     Snanning Proces Starts      ###################################################
...
#     sender_address = 'oppanchayat5@gmail.com'
#     sender_pass = 'panchayat5@AIML+DS'
#     # Setup the MIME
